...
import Profile from '../../public/cool-profile-pictures-aperture.webp';
const Navbar = () => {
        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5 flex items-center">
              ...
              <h1 className="text-3xl flex space-x-5 font-Outfit  leading-6 text-gray-900 font-extrabold">
                {" "}
                <span className="text-black"> </span>HomeGuard
              </h1>
            </a>
          </div>
          ...
          <div className="hidden lg:flex space-x-10 text-lg items-center">
            <a
              href="/Request"
              className="bg-green-600 text-white text-normal md:text-xl font-semibold p-2 rounded-md  hover:bg-green-700"
            >
              Request Demo
            </a>
          </div>
